...
function [error_start_pos, error_start_rot, error_target_pos, error_target_rot, t_duration] = mnpTJcontrol(g_start, g_start_above, g_target, g_target_above, g_im, ur5)
    ...
    ur5TJcontrol(g_start_above, ur5);
    fprintf('<- UR5 moved to g_start_above.\n');
    
    %% start_above -> start
    fprintf('\n-> UR5 started moving to g_start.\n');
    [error_start_pos, error_start_rot] = ur5TJcontrol(g_start, ur5);
